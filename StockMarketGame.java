...
public class StockMarketGame extends JFrame {
    ...
    private void initializeGameData() {
        // Initialize player with starting cash
    ...
    private void createMenuBar() {
        ...
        JMenuItem saveItem = new JMenuItem("Save Game (Not Implemented)");
        saveItem.setEnabled(false);
        gameMenu.add(saveItem);
        
        JMenuItem loadItem = new JMenuItem("Load Game (Not Implemented)");
